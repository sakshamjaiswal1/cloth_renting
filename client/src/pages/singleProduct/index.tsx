...
const SingleProduct = () => {
  ...
  return (
    <div className="pt-[1rem] w-[80%] m-auto flex justify-between">
      ...
      <div className="w-[50%] border-[1px solid red] h-[2rem]">
        ...
        <div className="flex py-[2rem]">
          <div>
            ...
            <FormControl sx={{ m: 1, minWidth: 120 }}>
              <InputLabel htmlFor="grouped-native-select">Duration</InputLabel>
        ...
        <div className="py-[1rem]">
          ...
          <p>
            Suit yourself! Put on this black formal staple with self-stripes in
            an elite imported woolen polyester blend.
          </p>
        </div>
        <div className="py-[1rem]">
          <p className="font-bold">Stylist's Notes</p>
          <p>Style this with the wooden musk bow tie for an outlandish look.</p>
        </div>
        <div className="py-[1rem]">
          <p className="font-bold">Material and Care</p>
          <p>
            All our outfits are sanitized and dry cleaned by us prior to
            delivery. If you must, please get it professional steam ironed only.
          </p>
        </div>
      </div>
    </div>
