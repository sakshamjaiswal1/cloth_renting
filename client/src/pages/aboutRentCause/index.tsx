        ...
        <div className="w-[65%] m-auto">
          ...
          <div className="py-[2rem]">
            <h1 className="text-[1.7rem] text-center">
              About Rent For A Cause
            </h1>
            <p className="text-center pt-[1rem]">
              We, at The Stylease, have always been firm believers of fashion
              for all. But somewhere in the midst of bringing luxury designers
              to every girl next door, we forget that there are those in the
              world who don’t even have the luxury of comfortable clothing.
            </p>
            <p className="text-center pt-[1rem]">
